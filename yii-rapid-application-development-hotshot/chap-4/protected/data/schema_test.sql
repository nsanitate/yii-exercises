...
INSERT INTO `book` VALUES (1,'Batman',2,'2012-05-08',50.00,3.00,'',0,1,1,NULL),(2,'The Amazing Spider Man',1,'2012-02-13',10.00,3.00,'This book is awesome. ',1,1,1,NULL),(3,'X-Men',3,'0000-00-00',5.00,1.00,'Awesome',1,6,0,NULL),(4,'Sandman',1,'2012-05-17',8.00,3.00,'',0,2,0,NULL),(5,'Green Lantern',3,'2012-05-01',3.00,3.00,'',0,1,0,NULL),(6,'Witchblade',3,'2000-03-01',15.00,2.00,'',0,1,1,NULL),(7,'300',2,'2002-10-01',15.00,3.00,'',0,6,0,NULL),(8,'Wolverine',3,'1982-05-01',67.00,1.00,'',1,1,1,NULL),(9,'Stardust',1,'0000-00-00',0.00,0.00,'',0,1,0,NULL);
UNLOCK TABLES;
...
INSERT INTO `bookauthor` VALUES (10,1),(12,5),(13,6),(12,31);
UNLOCK TABLES;
...
INSERT INTO `person` VALUES (1,'Comic','Author'),(2,'Illus','Trato'),(3,'Manga','Maniac'),(4,'Mike','Mignola'),(5,'Mike','Mignola'),(6,'Mike','Mignola');
UNLOCK TABLES;
...
INSERT INTO `user` VALUES (1,'admin','$1$3hLcBLJq$nly6jlBLe5UB8iAKm46is.',1),(2,'tuser','$1$u2t5ehMv$U9OuqqajvCvJobh36kslH.',2);
UNLOCK TABLES;
